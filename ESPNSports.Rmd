...
ESPNAnalyticsTime <- ESPNAnalytics %>% ggplot() +
  ...
  ggtitle("2015-2019 Gap Between High and Low ESPN Analytics Groups") +
  theme_dark() +
...
print(UofArkPresNew, target = "201111 2020 - Is Analytics in Professional Sports Making a Difference - U of Ark.pptx")
